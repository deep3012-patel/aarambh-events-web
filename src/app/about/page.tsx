...
export default function AboutPage() {
  return <>
    <PageHero eyebrow="About Aarambh" title="Turning moments into experiences." copy="A professional event planning, production, decoration and execution company for occasions that deserve thoughtful attention." image="https://images.unsplash.com/photo-1591604466107-ec97de577aff?auto=format&fit=crop&w=2200&q=88" />
    <section className="section-pad"><div className="shell about-story-grid">
      <Reveal className="about-image-wrap"><Image src="https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&w=1400&q=86" alt="Indian wedding decoration with flowers and warm light" fill sizes="(max-width: 900px) 90vw, 42vw" /></Reveal>
    ...
    <section className="section-pad section-dark"><div className="shell"><SectionHeading eyebrow="The people behind Aarambh" title="Jay &amp; Deep, bringing every detail together." copy="A founder-led event studio built on creative thinking, personal attention and dependable execution." /><div className="skills-grid">{skills.map((skill, index) => <Reveal key={skill} delay={index * 0.05}><div><Check size={17} />{skill}</div></Reveal>)}</div></div></section>
