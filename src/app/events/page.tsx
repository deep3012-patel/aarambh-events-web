...
export default function EventsPage() {
  return <>
    <PageHero eyebrow="Events we cover" title="For every reason to gather." copy="From intimate celebrations to public productions, we bring the same care to the idea, environment and execution." image="https://images.unsplash.com/photo-1544078751-58fee2d8a03b?auto=format&fit=crop&w=2200&q=88" />
