...
export default function WhyAarambhPage() {
  return <>
    <PageHero eyebrow="Why Aarambh" title="A clear vision, beautifully carried through." copy="Every experience benefits from someone keeping the creative idea and the practical details moving in the same direction." image="https://images.unsplash.com/photo-1507504031003-b417219a0fde?auto=format&fit=crop&w=2200&q=88" />
