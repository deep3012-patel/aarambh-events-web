...
export default function ServicesPage() {
  return <>
    <PageHero eyebrow="Our services" title="One team. Every essential detail." copy="Plan it, style it, stage it and deliver it with a partner that understands the complete event picture." image="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&w=2200&q=88" />
