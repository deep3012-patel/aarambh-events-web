...
export default function PortfolioPage() {
  return <>
    <PageHero eyebrow="Our portfolio" title="Spaces made for the moment." copy="Explore a curated collection of visual directions for celebrations, production and guest experiences. Share your brief and we will shape the right atmosphere for it." image="https://images.unsplash.com/photo-1606800052052-a08af7148866?auto=format&fit=crop&w=2200&q=88" />
