...
export default function ContactPage() {
  return <>
    <PageHero eyebrow="Contact Aarambh" title="Let&apos;s make the occasion unforgettable." copy="Tell us what you&apos;re planning. We&apos;ll get back to you with the right next steps—no booking required." image="https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?auto=format&fit=crop&w=2200&q=88" />
